...
$services = [
    [
        ...
        'title' => '3D Modeling',
        'desc'  => 'Membuat model 3D karakter atau objek sesuai kebutuhan proyek.',
        'i18n'  => 'svc_3dmodeling',
    ],
    [
        'icon'  => 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01',
        'title' => 'Texturing',
        'desc'  => 'Memberi warna dan tekstur pada model 3D agar sesuai referensi.',
        'i18n'  => 'svc_texturing',
    ],
    [
        'icon'  => 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1',
        'title' => 'Rigging',
        'desc'  => 'Membuat skeleton dan controller agar model 3D bisa digerakkan.',
        'i18n'  => 'svc_rigging',
    ],
    [
        'icon'  => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
        'title' => 'VRChat Setup (Unity)',
        'desc'  => 'Setup avatar agar siap pakai di VRChat melalui Unity dan VRChat SDK.',
        'i18n'  => 'svc_vrchat',
    ],
    [
        ...
        'desc'  => 'Setup GoGoLoco untuk animasi locomotion pada avatar.',
        'i18n'  => 'svc_gogoloco',
    ],
];
...
<main>
        ...
        <div class="mx-auto max-w-6xl px-5 pt-36 pb-16 grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
                <p class="inline-flex items-center gap-2 rounded-full border border-neutral-line bg-neutral-panel px-4 py-1.5 text-xs font-semibold text-neutral-soft shadow-sm reveal">
                    ...
                    <span data-i18n="hero_badge">Desain 2D &amp; 3D · Buka Order</span>
                </p>
                <h1 class="mt-6 font-display font-bold text-accent leading-[1.1] reveal hero-title">
                    <span data-i18n="hero_title_1">Desain</span>
                    <span data-i18n="hero_title_2">Karakter &amp; Visual</span>
                     <span class="relative text-primary"><span data-i18n="hero_title_3">Produk 2D &amp; 3D</span>
                ...
                <p class="mt-7 text-neutral-soft leading-relaxed max-w-lg reveal" data-i18n="hero_desc">
                    Kami menyediakan aset karakter 2D &amp; 3D serta video promosi yang siap pakai untuk animasi dan kebutuhan marketing.
                </p>
                <div class="mt-9 flex flex-wrap gap-4 reveal">
                    <a href="#portfolio" class="rounded-full bg-primary hover:bg-secondary text-neutral font-semibold px-7 py-3 transition" data-i18n="hero_cta_portfolio">
                        Lihat Portofolio
                    </a>
                    <a href="#contact" class="rounded-full border border-neutral-line hover:border-primary hover:text-primary text-accent font-semibold px-7 py-3 transition" data-i18n="hero_cta_project">
                        Diskusi Proyek
                    </a>
                </div>
            ...
            <div class="relative reveal">
                <div class="rounded-[2rem] border border-neutral-line bg-neutral-panel p-8 sm:p-12">
                    ...
                    <p class="text-center text-xs text-neutral-soft mt-1" data-i18n="hero_location">Desain 2D &amp; 3D · Banjarnegara, Jawa Tengah Indonesia</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-6xl px-5">
            <div class="flex items-end justify-between flex-wrap gap-4">
                <div>
                    <p class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary reveal">
                        <span class="w-8 h-px bg-primary"></span> <span data-i18n="services_label">Layanan</span>
                    </p>
                    <h2 class="mt-3 font-display text-3xl sm:text-4xl font-bold text-accent reveal" data-i18n="services_title">Yang Kami Kerjakan</h2>
                </div>
                <p class="text-base text-neutral-soft max-w-xs reveal" data-i18n="services_desc">Mulai dari satu poster sampai satu sistem identitas brand — semua dikerjakan dengan standar yang sama.</p>
            </div>
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2">
                ...
                <div class="reveal group glow-click rounded-3xl border border-neutral-line bg-neutral-panel p-8 hover:-translate-y-1 transition">
                    ...
                    <p class="mt-2 text-base text-neutral-soft leading-relaxed" data-i18n="<?= htmlspecialchars($s['i18n']) ?>"><?= htmlspecialchars($s['desc']) ?></p>
                    <a href="#contact" class="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-primary group-hover:gap-3 transition-all">
                        <span data-i18n="service_discuss">Mulai diskusi</span>
    ...
    <section id="portfolio" class="relative py-24 bg-neutral-panel border-y border-neutral-line overflow-hidden">
        ...
        <div class="relative mx-auto max-w-6xl px-5">
            <div class="flex items-end justify-between flex-wrap gap-4">
                <div>
                    <p class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary reveal">
                        <span class="w-8 h-px bg-primary"></span> <span data-i18n="portfolio_label">Portofolio</span>
                    </p>
                    <h2 class="mt-3 font-display text-3xl sm:text-4xl font-bold text-accent reveal" data-i18n="portfolio_title">Karya Pilihan</h2>
                </div>

                <div class="flex flex-wrap gap-2 reveal" id="filterBar">
                    <button class="filter-btn active rounded-full px-5 py-2 text-sm font-semibold transition" data-filter="all" data-i18n="portfolio_all">Semua</button>
        ...
        <div class="mx-auto max-w-6xl px-5 grid gap-12 lg:grid-cols-2 lg:items-center">
            <div class="relative reveal">
                ...
                <div class="absolute -bottom-6 left-8 rounded-2xl border border-neutral-line bg-neutral-panel px-5 py-3 shadow-md">
                    ...
                    <p class="text-xs text-neutral-soft mt-0.5" data-i18n="about_est">Berkarya sejak</p>
                </div>
            </div>
            <div>
                <p class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary reveal">
                    <span class="w-8 h-px bg-primary"></span> <span data-i18n="about_label">Tentang</span>
                </p>
                <h2 class="mt-3 font-display text-3xl sm:text-4xl font-bold text-accent reveal" data-i18n="about_title">Di Balik SEMUT Studio</h2>
                <p class="mt-6 text-neutral-soft leading-relaxed reveal" data-i18n="about_desc">
                    Hai! Saya seorang seniman 3D yang fokus, teliti, dan tak kenal lelah di AntNest 🐜.
                    Saya mengkhususkan diri dalam Pemodelan Karakter 3D, Karakter Lucu, Render, Pencetakan 3D, dan Seni NFT menggunakan Blender.
                    Layaknya koloni semut, saya membangun setiap proyek dengan presisi dan penuh perhatian.
                    Mari wujudkan ide-ide Anda, satu poligon demi satu poligon!
                </p>
    ...
    <section id="testimonials" class="relative py-24 bg-neutral-panel border-y border-neutral-line overflow-hidden">
        ...
        <div class="relative mx-auto max-w-6xl px-5">
            <p class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary reveal">
                <span class="w-8 h-px bg-primary"></span> <span data-i18n="testi_label">Testimoni</span>
            </p>
            <h2 class="mt-3 font-display text-3xl sm:text-4xl font-bold text-accent reveal" data-i18n="testi_title">Review Pelanggan</h2>
                    ...
                    <button type="button" class="review-open relative z-10 w-full block text-left p-7"
                        ...
                        <div class="tilt-body">
                            ...
                            <span class="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-primary group-hover:gap-3 transition-all">
                                <span data-i18n="testi_readmore">Baca review lengkap</span>
            ...
            <div class="mt-14 text-center reveal">
                <button id="reviewFormToggle" type="button" aria-expanded="false"
                    ...
                    <span data-i18n="testi_write">Tulis Review</span>
                </button>
            </div>
            ...
            <div id="reviewFormWrap" class="hidden mt-10 max-w-2xl mx-auto">
                <div class="rounded-3xl border border-neutral-line bg-neutral-panel p-8">
                    <h3 class="font-display font-semibold text-accent text-xl" data-i18n="testi_form_title">Bagikan Pengalamanmu</h3>
                    <p class="mt-2 text-sm text-neutral-soft" data-i18n="testi_form_desc">Sudah pernah bekerja sama? Ceritakan pengalamanmu — review akan tampil setelah disetujui admin.</p>
                    <form id="reviewForm" class="mt-6 space-y-5">
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div>
                                <label for="rfName" class="block text-sm font-medium text-accent mb-2" data-i18n="testi_name">Nama</label>
                                <input type="text" id="rfName" name="name" required
                                       ...
                                       data-i18n-placeholder="testi_name_ph" placeholder="Nama kamu">
                            </div>
                            <div>
                                <label for="rfRole" class="block text-sm font-medium text-accent mb-2" data-i18n="testi_role">Jabatan / Brand</label>
                                <input type="text" id="rfRole" name="role"
                                       class="w-full rounded-xl bg-neutral border border-neutral-line px-4 py-3 text-sm placeholder-neutral-soft/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                                       data-i18n-placeholder="testi_role_ph" placeholder="cth: Owner, Online Store">
                            </div>
                        </div>
                            <div>
                                <label for="rfRating" class="block text-sm font-medium text-accent mb-2" data-i18n="testi_rating">Rating</label>
                                <select id="rfRating" name="rating" class="w-full rounded-xl bg-neutral border border-neutral-line px-4 py-3 text-sm focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20">
                                    <option value="5" data-i18n="testi_rating_5">5 — Luar biasa</option>
                                    <option value="4" data-i18n="testi_rating_4">4 — Bagus</option>
                                    <option value="3" data-i18n="testi_rating_3">3 — Cukup</option>
                                    <option value="2" data-i18n="testi_rating_2">2 — Kurang</option>
                                    <option value="1" data-i18n="testi_rating_1">1 — Buruk</option>
                                </select>
                            </div>
                            <div>
                                <label for="rfReview" class="block text-sm font-medium text-accent mb-2" data-i18n="testi_review">Review</label>
                                <textarea id="rfReview" name="review" rows="4" required
                                          ...
                                          data-i18n-placeholder="testi_review_ph" placeholder="Ceritakan pengalamanmu bekerja dengan kami..."></textarea>
                            </div>
                            <button type="submit"
                                    class="w-full rounded-xl bg-primary hover:bg-secondary text-neutral font-semibold px-6 py-3.5 transition" data-i18n="testi_submit">
                                Kirim Review
                            </button>
    ...
    <section id="contact" class="py-24">
        <div class="mx-auto max-w-6xl px-5 grid gap-12 lg:grid-cols-2">
            <div>
                <p class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary reveal">
                    <span class="w-8 h-px bg-primary"></span> <span data-i18n="contact_label">Kontak</span>
                </p>
                <h2 class="mt-3 font-display text-3xl sm:text-4xl font-bold text-accent reveal" data-i18n="contact_title">Mulai Proyekmu Sekarang</h2>
                <p class="mt-6 text-neutral-soft leading-relaxed reveal" data-i18n="contact_desc">
                ...
                <div class="mt-8 space-y-4 reveal">
                    <a href="mailto:<?= htmlspecialchars($config['social']['email']) ?>" class="flex items-center gap-4 text-sm text-accent hover:text-primary transition group">
                        ...
                        <span>
                            <span class="block text-xs text-neutral-soft" data-i18n="contact_email_label">Email</span>
                    ...
                    <a href="<?= htmlspecialchars($config['social']['instagram']) ?>" class="flex items-center gap-4 text-sm text-accent hover:text-primary transition group" target="_blank" rel="noopener">
                        ...
                        <span>
                            <span class="block text-xs text-neutral-soft" data-i18n="contact_instagram">Instagram</span>
                            @semutstudio25
                        </span>
                    </a>
                    <a href="<?= htmlspecialchars($config['social']['fiverr']) ?>" class="flex items-center gap-4 text-sm text-accent hover:text-primary transition group" target="_blank" rel="noopener">
                        ...
                        <span>
                            <span class="block text-xs text-neutral-soft" data-i18n="contact_fiverr">Fiverr</span>
            ...
            <form id="contactForm" class="reveal rounded-3xl border border-neutral-line bg-neutral-panel p-8 space-y-5">
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        <label for="cfName" class="block text-sm font-medium text-accent mb-2" data-i18n="contact_name">Nama</label>
                        <input type="text" id="cfName" name="name" required
                               class="w-full rounded-xl bg-neutral border border-neutral-line px-4 py-3 text-sm placeholder-neutral-soft/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                               data-i18n-placeholder="contact_name_ph" placeholder="Nama kamu">
                    </div>
                    <div>
                        <label for="cfEmail" class="block text-sm font-medium text-accent mb-2" data-i18n="contact_email_label">Email</label>
                        <input type="email" id="cfEmail" name="email" required
                               class="w-full rounded-xl bg-neutral border border-neutral-line px-4 py-3 text-sm placeholder-neutral-soft/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                               data-i18n-placeholder="contact_email_ph" placeholder="email@kamu.com">
                    </div>
                </div>
                <div>
                    <label for="cfSubject" class="block text-sm font-medium text-accent mb-2" data-i18n="contact_project_type">Jenis Proyek</label>
                    <select id="cfSubject" name="subject" class="w-full rounded-xl bg-neutral border border-neutral-line px-4 py-3 text-sm focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20">
                        ...
                        <option value="Lainnya" data-i18n="contact_other">Lainnya</option>
                    </select>
                </div>
                <div>
                    <label for="cfMessage" class="block text-sm font-medium text-accent mb-2" data-i18n="contact_message">Pesan</label>
                    <textarea id="cfMessage" name="message" rows="4" required
                              class="w-full rounded-xl bg-neutral border border-neutral-line px-4 py-3 text-sm placeholder-neutral-soft/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 resize-none"
                              data-i18n-placeholder="contact_message_ph" placeholder="Ceritakan kebutuhanmu..."></textarea>
                </div>
                <button type="submit"
                        class="w-full rounded-xl bg-primary hover:bg-secondary text-neutral font-semibold px-6 py-3.5 transition" data-i18n="contact_submit">
                    Kirim Pesan
                </button>
...
<div id="lightbox" class="fixed inset-0 z-[60] hidden items-center justify-center bg-black/70 backdrop-blur-sm p-5" role="dialog" aria-modal="true" aria-label="Detail karya">
    <div class="relative max-w-3xl w-full rounded-3xl border border-neutral-line bg-neutral-panel p-6 sm:p-8 shadow-2xl">
        <button id="lightboxClose" class="absolute top-4 right-4 w-9 h-9 rounded-full bg-neutral text-neutral-soft hover:text-primary flex items-center justify-center transition" aria-label="Tutup" data-i18n-aria="aria_close">
...
<div id="reviewLightbox" class="fixed inset-0 z-[60] hidden items-center justify-center bg-black/70 backdrop-blur-sm p-5" role="dialog" aria-modal="true" aria-label="Detail review">
    <div class="relative max-w-2xl w-full rounded-3xl border border-neutral-line bg-neutral-panel p-6 sm:p-8 shadow-2xl">
        <button id="reviewLightboxClose" class="absolute top-4 right-4 w-9 h-9 rounded-full bg-neutral text-neutral-soft hover:text-primary flex items-center justify-center transition" aria-label="Tutup" data-i18n-aria="aria_close">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>
        </button>
...
<!-- ===================== BACK TO TOP ===================== -->
<button id="backToTop" class="back-to-top" aria-label="Kembali ke atas" data-i18n-aria="skip_to_content">
